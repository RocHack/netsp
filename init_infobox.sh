...
for C in $computers; do
    ssh $C "pkill infobox.pl; cd www/csugnet/; ./infobox.pl";
done;
for C in $computers_notmux; do
    ssh $C "pkill infobox.pl; cd www/csugnet/; ./infobox.pl -l";
done;
for C in $printers; do
    ssh $extra_loc "cd www/csugnet/; ./infobox.pl -p $C";
done;
for C in $nfs_u; do
    ssh $extra_loc "cd www/csugnet/; ./infobox.pl -u $C";
done;
for C in $nfs_w; do
    ssh $extra_loc "cd www/csugnet/; ./infobox.pl -w $C";
done;
for C in $nfs_m; do
    ssh $extra_loc "cd www/csugnet/; ./infobox.pl -m $C";
done;
